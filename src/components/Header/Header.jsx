                        ...
                        <div className="container-fluid">
                                ...
                                <div className="sidebar-toggle cursor-pointer d-flex align-items-center justify-content-center bg-transparent border-0 p-0 opened">
                                    <button className=' w-36px h-36px' onClick={onToggleSidebar} >
                                        {isSidebarOpen ? (
                                            ...
                                            <i className="bi bi-list h2 d-flex justify-content-center "></i>
                                ...
                                <div className="title-breadcrumb d-lg-flex flex-column ms-3 d-none ">
                                    ...
                                    <ul className="breadcrumb mb-1">
                                        <li className="breadcrumb-item ">
                                            <a href="/" role="button" tabIndex="0">خانه</a>
                                        </li>
                                        <li className="breadcrumb-item active">
                                            <a href="/" role="button" tabIndex="0">داشبورد</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div className="toolbar d-flex align-items-center order-0 order-lg-1">
                                <div className="toggleable-toolbar d-flex align-items-center">
                                    <button className='btn-header rounded d-flex align-items-center w-36px h-36px p-2 me-2'><i className="bi bi-search  h5 d-flex justify-content-center pt-2"></i></button>
                                    <button className='btn-header rounded d-flex align-items-center w-36px h-36px p-2 me-2'><i className="bi bi-chat  h5 d-flex justify-content-center pt-2"></i></button>
                                    <button className='btn-header rounded d-flex align-items-center w-36px h-36px p-2 me-2'><i className="bi bi-bell  h5 d-flex justify-content-center pt-2"></i></button>
                                    <button className='btn-header rounded d-flex align-items-center w-36px h-36px p-2 me-2'><i className="bi bi-person  h5 d-flex justify-content-center pt-2"></i></button>
                                </div>
                            </div>
                        </div>
                    </nav>
